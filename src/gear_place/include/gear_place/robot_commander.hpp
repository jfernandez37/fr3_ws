...
private:
  ...
  std::map<std::string, std::array<double, 7>> named_joint_positions_ = {
      ...
      {"single_scan_1",{{0.08348078422,0.2053326663,0.0,-1.93140047,0.0,2.15373748,-0.7316605506}}},
      {"single_scan_2",{{-0.08183429,0.2042352775,0.0,-1.931527285588394,0.0,2.1557214527962776,2.3650981629688017}}},
